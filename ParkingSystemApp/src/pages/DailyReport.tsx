...
const DailyReport=()=>{
    ...
    return(
        <>
            <button className="bg-green-400 rounded-md p-2" onClick={()=>genExcel()}>GENERAR EXCEL</button>
            <table className="my-auto text-[85%] shadow-xl">
                <thead className="">
                ...
                <tbody>
                    {todayTick?
                        todayTick.map((e)=>(
                            <tr key={e.NRO} className="text-[80%] text-[#3b3b3b] bg-[#ffffff59] hover:bg-[#ffffffad]">
